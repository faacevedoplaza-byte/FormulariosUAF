...
{
    /// <inheritdoc />
    public partial class AddNotificationsAndSignatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignerIdNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SignedPdfPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SignatureRecords_Requests_RequestId",
