        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RequestType = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ClientToken = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_Usuarios_VendorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBeneficialOwner = table.Column<bool>(type: "bit", nullable: false),
                    IsEffectiveControl = table.Column<bool>(type: "bit", nullable: false),
                    IsPEP = table.Column<bool>(type: "bit", nullable: false),
                    PepDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BeneficialOwners_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelationshipWithLegalEntity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeclaresUnderOath = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Declarants_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentTypeOther = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Country = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ParticipationPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    IsPEP = table.Column<bool>(type: "bit", nullable: false),
                    PepDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EffectiveControllers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EffectiveControllers_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CountryOfIncorporation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LegalRepresentativeIdNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LegalRepresentativeName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EntityType = table.Column<int>(type: "int", nullable: false),
                    EntityTypeOther = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LegalEntityDeclarations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LegalEntityDeclarations_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeclaresPEP = table.Column<bool>(type: "bit", nullable: false),
                    PepName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Institution = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PepReasonType = table.Column<int>(type: "int", nullable: true),
                    PepReasonOther = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VinculoType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeclarationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AcceptsUnderOath = table.Column<bool>(type: "bit", nullable: false),
                    SignatureFullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SignatureIdNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SignatureDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SignatureIpAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SignatureUserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PepDeclarations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PepDeclarations_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileStorageRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileStorageRecords_Documents_DocumentId",
